  ...
  return (
    <div className="fixed bottom-[100px] left-0 right-0 ml-auto mr-auto max-w-5xl z-20">
      <Link
        ...
        className="max-w-[200px] ml-auto mr-auto flex h-12 cursor-pointer items-center justify-center gap-2 overflow-hidden rounded-full bg-primary px-5 text-background-dark "
      >
